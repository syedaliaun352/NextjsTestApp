        ...
        <>
            <div className="m-2 p-2 mx-auto text-white flex flex-col items-center justify-center">
                ...
                <div className="w-full max-w-lg">
                    <form action="" onSubmit={onSubmit} className="mt-10 bg-gray-900 flex flex-col mx-auto p-5 rounded-2xl border border-green-500 shadow-md">
                        ...
                        <div>
                            <p className='text-center'>
                                Already have a Account? <span className='text-blue-400 hover:text-blue-600 duration-300 cursor-pointer' onClick={() => router.push('/register/login')}>Login Here</span>
                            </p>
                        </div>
                    </form>
                </div>
